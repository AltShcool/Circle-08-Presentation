import{d as _,a4 as u,z as f,f as n,g as t,t as s,X as c,F as h,aj as g,o as i,i as v,e as x,ad as b}from"../modules/vue-DnfkPNEi.js";import{a as y,u as N}from"../index-OtCFIimV.js";import{a as m}from"../monaco/bundled-types-DammcoRR.js";import{_ as k}from"./NoteDisplay.vue_vue_type_style_index_0_lang-BS7jI620.js";import"../modules/shiki-Cj2c-_Dm.js";import"../modules/file-saver-BzOOqXCn.js";const w={id:"page-root"},L={class:"m-4"},T={class:"mb-10"},V={class:"text-4xl font-bold mt-2"},B={class:"opacity-50"},H={class:"text-lg"},S={class:"font-bold flex gap-2"},j={class:"opacity-50"},z={key:0,class:"border-main mb-8"},W=_({__name:"print",setup(C){const{slides:d,total:p}=y();u(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
